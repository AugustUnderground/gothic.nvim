...
local highlights = {
  Character  = { fg = palette.color27, },
  CocBold    = {    bold = true },
  CocCodeLens = { fg = palette.color21, },
  CocCursorTransparent = {    blend = 100,   strikethrough = true },
  ...
  CocListBlackBlack = { fg = palette.color1, bg = palette.color1, },
  CocListBlackBlue = { fg = palette.color1, bg = palette.color2, },
  CocListBlackCyan = { fg = palette.color1, bg = palette.color6, },
  CocListBlackGreen = { fg = palette.color1, bg = palette.color3, },
  CocListBlackGrey = { fg = palette.color1, bg = palette.color4, },
  CocListBlackMagenta = { fg = palette.color1, bg = palette.color0, },
  CocListBlackRed = { fg = palette.color1, bg = palette.color8, },
  CocListBlackWhite = { fg = palette.color1, bg = palette.color5, },
  CocListBlackYellow = { fg = palette.color1, bg = palette.color7, },
  CocListBlueBlack = { fg = palette.color2, bg = palette.color1, },
  CocListBlueBlue = { fg = palette.color2, bg = palette.color2, },
  CocListBlueCyan = { fg = palette.color2, bg = palette.color6, },
  CocListBlueGreen = { fg = palette.color2, bg = palette.color3, },
  CocListBlueGrey = { fg = palette.color2, bg = palette.color4, },
  CocListBlueMagenta = { fg = palette.color2, bg = palette.color0, },
  CocListBlueRed = { fg = palette.color2, bg = palette.color8, },
  CocListBlueWhite = { fg = palette.color2, bg = palette.color5, },
  CocListBlueYellow = { fg = palette.color2, bg = palette.color7, },
  CocListCyanBlack = { fg = palette.color6, bg = palette.color1, },
  CocListCyanBlue = { fg = palette.color6, bg = palette.color2, },
  CocListCyanCyan = { fg = palette.color6, bg = palette.color6, },
  CocListCyanGreen = { fg = palette.color6, bg = palette.color3, },
  CocListCyanGrey = { fg = palette.color6, bg = palette.color4, },
  CocListCyanMagenta = { fg = palette.color6, bg = palette.color0, },
  CocListCyanRed = { fg = palette.color6, bg = palette.color8, },
  CocListCyanWhite = { fg = palette.color6, bg = palette.color5, },
  CocListCyanYellow = { fg = palette.color6, bg = palette.color7, },
  ...
  CocListGreenBlack = { fg = palette.color3, bg = palette.color1, },
  CocListGreenBlue = { fg = palette.color3, bg = palette.color2, },
  CocListGreenCyan = { fg = palette.color3, bg = palette.color6, },
  CocListGreenGreen = { fg = palette.color3, bg = palette.color3, },
  CocListGreenGrey = { fg = palette.color3, bg = palette.color4, },
  CocListGreenMagenta = { fg = palette.color3, bg = palette.color0, },
  CocListGreenRed = { fg = palette.color3, bg = palette.color8, },
  CocListGreenWhite = { fg = palette.color3, bg = palette.color5, },
  CocListGreenYellow = { fg = palette.color3, bg = palette.color7, },
  CocListGreyBlack = { fg = palette.color4, bg = palette.color1, },
  CocListGreyBlue = { fg = palette.color4, bg = palette.color2, },
  CocListGreyCyan = { fg = palette.color4, bg = palette.color6, },
  CocListGreyGreen = { fg = palette.color4, bg = palette.color3, },
  CocListGreyGrey = { fg = palette.color4, bg = palette.color4, },
  CocListGreyMagenta = { fg = palette.color4, bg = palette.color0, },
  CocListGreyRed = { fg = palette.color4, bg = palette.color8, },
  CocListGreyWhite = { fg = palette.color4, bg = palette.color5, },
  CocListGreyYellow = { fg = palette.color4, bg = palette.color7, },
  CocListMagentaBlack = { fg = palette.color0, bg = palette.color1, },
  CocListMagentaBlue = { fg = palette.color0, bg = palette.color2, },
  CocListMagentaCyan = { fg = palette.color0, bg = palette.color6, },
  CocListMagentaGreen = { fg = palette.color0, bg = palette.color3, },
  CocListMagentaGrey = { fg = palette.color0, bg = palette.color4, },
  CocListMagentaMagenta = { fg = palette.color0, bg = palette.color0, },
  CocListMagentaRed = { fg = palette.color0, bg = palette.color8, },
  CocListMagentaWhite = { fg = palette.color0, bg = palette.color5, },
  CocListMagentaYellow = { fg = palette.color0, bg = palette.color7, },
  CocListRedBlack = { fg = palette.color8, bg = palette.color1, },
  CocListRedBlue = { fg = palette.color8, bg = palette.color2, },
  CocListRedCyan = { fg = palette.color8, bg = palette.color6, },
  CocListRedGreen = { fg = palette.color8, bg = palette.color3, },
  CocListRedGrey = { fg = palette.color8, bg = palette.color4, },
  CocListRedMagenta = { fg = palette.color8, bg = palette.color0, },
  CocListRedRed = { fg = palette.color8, bg = palette.color8, },
  CocListRedWhite = { fg = palette.color8, bg = palette.color5, },
  CocListRedYellow = { fg = palette.color8, bg = palette.color7, },
  CocListWhiteBlack = { fg = palette.color5, bg = palette.color1, },
  CocListWhiteBlue = { fg = palette.color5, bg = palette.color2, },
  CocListWhiteCyan = { fg = palette.color5, bg = palette.color6, },
  CocListWhiteGreen = { fg = palette.color5, bg = palette.color3, },
  CocListWhiteGrey = { fg = palette.color5, bg = palette.color4, },
  CocListWhiteMagenta = { fg = palette.color5, bg = palette.color0, },
  CocListWhiteRed = { fg = palette.color5, bg = palette.color8, },
  CocListWhiteWhite = { fg = palette.color5, bg = palette.color5, },
  CocListWhiteYellow = { fg = palette.color5, bg = palette.color7, },
  CocListYellowBlack = { fg = palette.color7, bg = palette.color1, },
  CocListYellowBlue = { fg = palette.color7, bg = palette.color2, },
  CocListYellowCyan = { fg = palette.color7, bg = palette.color6, },
  CocListYellowGreen = { fg = palette.color7, bg = palette.color3, },
  CocListYellowGrey = { fg = palette.color7, bg = palette.color4, },
  CocListYellowMagenta = { fg = palette.color7, bg = palette.color0, },
  CocListYellowRed = { fg = palette.color7, bg = palette.color8, },
  CocListYellowWhite = { fg = palette.color7, bg = palette.color5, },
  CocListYellowYellow = { fg = palette.color7, bg = palette.color7, },
  CocSelectedText = { fg = palette.color20, },
  CocUnderline = {    underline = true },
  CocWarningSign = { fg = palette.color17, },
  ColorColumn = { bg = palette.color48, },
  Comment    = { fg = palette.color23, },
  Conceal    = { fg = palette.color45, bg = palette.color46, },
  Constant   = { fg = palette.color50, },
  Cursor     = { fg = palette.color25, bg = palette.color32, },
  CursorColumn = { bg = palette.color47, },
  CursorLineNr = { fg = palette.color30,    bold = true },
  DiffAdd    = { fg = palette.color22, bg = palette.color25, },
  DiffChange = { fg = palette.color43, bg = palette.color25, },
  DiffDelete = { fg = palette.color30, bg = palette.color25,    bold = true },
  DiffText   = { fg = palette.color44, bg = palette.color25,    bold = true },
  Directory  = { fg = palette.color34, },
  EndOfBuffer = { fg = palette.color25, },
  Error      = { fg = palette.color51, bg = palette.color25, },
  ErrorMsg   = { fg = palette.color36, bg = palette.color16, },
  FloatShadow = { bg = palette.color10,    blend = 80 },
  FloatShadowThrough = { bg = palette.color10,    blend = 100 },
  FoldColumn = { fg = palette.color34, bg = palette.color42, },
  Folded     = { fg = palette.color25, bg = palette.color26, },
  Identifier = { fg = palette.color30, },
  Ignore     = { fg = palette.color25, },
  IncSearch  = { fg = palette.color32, bg = palette.color37,    reverse = true },
  LightlineLeft_command_0 = { fg = palette.color10, bg = palette.color13, },
  LightlineLeft_command_0_1 = { fg = palette.color13, bg = palette.color11, },
  LightlineLeft_command_0_tabsel = { fg = palette.color13, bg = palette.color10, },
  LightlineLeft_command_1 = { fg = palette.color12, bg = palette.color11, },
  LightlineLeft_command_1_2 = { fg = palette.color11, bg = palette.color10, },
  LightlineLeft_command_1_tabsel = { fg = palette.color11, bg = palette.color10, },
  LightlineLeft_command_tabsel = { fg = palette.color13, bg = palette.color10, },
  LightlineLeft_command_tabsel_0 = { fg = palette.color10, bg = palette.color13, },
  LightlineLeft_command_tabsel_1 = { fg = palette.color10, bg = palette.color11, },
  LightlineLeft_command_tabsel_2 = { fg = palette.color10, bg = palette.color10, },
  LightlineLeft_command_tabsel_tabsel = { fg = palette.color10, bg = palette.color10, },
  LightlineLeft_normal_0 = { fg = palette.color10, bg = palette.color13, },
  LightlineLeft_normal_0_1 = { fg = palette.color13, bg = palette.color11, },
  LightlineLeft_normal_0_tabsel = { fg = palette.color13, bg = palette.color10, },
  LightlineLeft_normal_1 = { fg = palette.color12, bg = palette.color11, },
  LightlineLeft_normal_1_2 = { fg = palette.color11, bg = palette.color10, },
  LightlineLeft_normal_1_tabsel = { fg = palette.color11, bg = palette.color10, },
  LightlineLeft_normal_tabsel = { fg = palette.color13, bg = palette.color10, },
  LightlineLeft_normal_tabsel_0 = { fg = palette.color10, bg = palette.color13, },
  LightlineLeft_normal_tabsel_1 = { fg = palette.color10, bg = palette.color11, },
  LightlineLeft_normal_tabsel_2 = { fg = palette.color10, bg = palette.color10, },
  LightlineLeft_normal_tabsel_tabsel = { fg = palette.color10, bg = palette.color10, },
  LightlineMiddle_command = { fg = palette.color9, bg = palette.color10, },
  LightlineMiddle_normal = { fg = palette.color9, bg = palette.color10, },
  LightlineRight_command_0 = { fg = palette.color9, bg = palette.color12, },
  LightlineRight_command_0_1 = { fg = palette.color12, bg = palette.color9, },
  LightlineRight_command_0_tabsel = { fg = palette.color12, bg = palette.color10, },
  LightlineRight_command_1 = { fg = palette.color15, bg = palette.color9, },
  LightlineRight_command_1_2 = { fg = palette.color9, bg = palette.color11, },
  LightlineRight_command_1_tabsel = { fg = palette.color9, bg = palette.color10, },
  LightlineRight_command_2 = { fg = palette.color14, bg = palette.color11, },
  LightlineRight_command_2_3 = { fg = palette.color11, bg = palette.color10, },
  LightlineRight_command_2_tabsel = { fg = palette.color11, bg = palette.color10, },
  LightlineRight_command_tabsel = { fg = palette.color13, bg = palette.color10, },
  LightlineRight_command_tabsel_0 = { fg = palette.color10, bg = palette.color12, },
  LightlineRight_command_tabsel_1 = { fg = palette.color10, bg = palette.color9, },
  LightlineRight_command_tabsel_2 = { fg = palette.color10, bg = palette.color11, },
  LightlineRight_command_tabsel_3 = { fg = palette.color10, bg = palette.color10, },
  LightlineRight_command_tabsel_tabsel = { fg = palette.color10, bg = palette.color10, },
  LightlineRight_normal_0 = { fg = palette.color9, bg = palette.color12, },
  LightlineRight_normal_0_1 = { fg = palette.color12, bg = palette.color9, },
  LightlineRight_normal_0_tabsel = { fg = palette.color12, bg = palette.color10, },
  LightlineRight_normal_1 = { fg = palette.color15, bg = palette.color9, },
  LightlineRight_normal_1_2 = { fg = palette.color9, bg = palette.color11, },
  LightlineRight_normal_1_tabsel = { fg = palette.color9, bg = palette.color10, },
  LightlineRight_normal_2 = { fg = palette.color14, bg = palette.color11, },
  LightlineRight_normal_2_3 = { fg = palette.color11, bg = palette.color10, },
  LightlineRight_normal_2_tabsel = { fg = palette.color11, bg = palette.color10, },
  LightlineRight_normal_tabsel = { fg = palette.color13, bg = palette.color10, },
  LightlineRight_normal_tabsel_0 = { fg = palette.color10, bg = palette.color12, },
  LightlineRight_normal_tabsel_1 = { fg = palette.color10, bg = palette.color9, },
  LightlineRight_normal_tabsel_2 = { fg = palette.color10, bg = palette.color11, },
  LightlineRight_normal_tabsel_3 = { fg = palette.color10, bg = palette.color10, },
  LightlineRight_normal_tabsel_tabsel = { fg = palette.color10, bg = palette.color10, },
  LineNr     = { fg = palette.color23, },
  MatchParen = { fg = palette.color32, bg = palette.color37, },
  ModeMsg    = {    bold = true },
  MoreMsg    = { fg = palette.color38,    bold = true },
  Noise      = { fg = palette.color22, },
  NonText    = { fg = palette.color35,    bold = true },
  Normal     = { fg = palette.color32, bg = palette.color25, },
  NvimInternalError = { fg = palette.color16, bg = palette.color16, },
  Pmenu      = { fg = palette.color25, bg = palette.color41, },
  PmenuSbar  = { bg = palette.color32, },
  PmenuSel   = { fg = palette.color41, bg = palette.color37, },
  PmenuThumb = { bg = palette.color23, },
  PreProc    = { fg = palette.color22, },
  Question   = { fg = palette.color39,    bold = true },
  QuickScopePrimary = { fg = palette.color28,    underline = true },
  QuickScopeSecondary = { fg = palette.color29,    underline = true },
  RedrawDebugClear = { bg = palette.color49, },
  RedrawDebugComposed = { bg = palette.color39, },
  RedrawDebugNormal = {    reverse = true },
  RedrawDebugRecompose = { bg = palette.color16, },
  Search     = { fg = palette.color32, bg = palette.color37, },
  ...
  Statement  = { fg = palette.color22,    bold = true },
  StatusLine = { fg = palette.color37, bg = palette.color32,    bold = true,   reverse = true },
  StatusLineNC = { fg = palette.color32, bg = palette.color37,    reverse = true },
  ...
  TabLine    = { bg = palette.color46,    underline = true },
  TabLineFill = {    reverse = true },
  TabLineSel = {    bold = true },
  TermCursor = {    reverse = true },
  Title      = { fg = palette.color40,    bold = true },
  Todo       = { fg = palette.color25, bg = palette.color26, },
  Type       = { fg = palette.color22,    bold = true },
  Underlined = { fg = palette.color24,    underline = true },
  VertSplit  = { fg = palette.color32, bg = palette.color25, },
  Visual     = { fg = palette.color32, bg = palette.color37, },
  WarningMsg = { fg = palette.color16, },
  WildMenu   = { fg = palette.color37, bg = palette.color41, },
  ...
  lCursor    = { fg = palette.color25, bg = palette.color32, },
